...
const Layout = ({ children }: Props) => {
  ...
  return (
    <motion.div
      ...
      animate={{
        backgroundImage: `radial-gradient(ellipse 98% 35% at ${activeGradient.positionX} ${activeGradient.positionY}, rgba(${activeGradient.color}, 0.1), transparent 60%), linear-gradient(to bottom, rgba(${activeGradient.color}, 0.1), #111827)`,
      }}
